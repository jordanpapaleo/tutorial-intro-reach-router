...
export const Slide6 = () => (
  <div className='class-section'>
    ...
    <ol>
      ...
      <li>Go to the <a href='https://codesandbox.io/s/github/jordanpapaleo/tutorial-intro-reach-router/tree/master' target='_blank'><strong>Coolest Sandbox EVER</strong></a></li>
    </ol>
  </div>
)
